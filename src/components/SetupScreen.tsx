    ...
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50">
      <div className="h-full overflow-y-auto">
        <div className="max-w-md mx-auto p-6 pb-20">
          ...
          {/* User Profile Info (Non-admin users) */}
          {!profile.is_admin && (
            <Card className="rounded-3xl shadow-xl bg-white/80 backdrop-blur-sm border-0 mb-6">
              <CardHeader>
                <CardTitle className="text-lg bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl">
                  ...
                  <div>
                    <p className="font-medium text-gray-700 text-lg">{profile.name}</p>
                    <p className="text-sm text-gray-500">Caretaker</p>
                    {profile.phone_number && (
                      <p className="text-sm text-gray-500">Code: {profile.phone_number}</p>
                    )}
                  </div>
                </div>
                ...
                {/* Passcode Update */}
                <div className="space-y-3">
                  <Label className="text-sm font-medium text-gray-700">Update Your Passcode</Label>
                  {editingPasscode ? (
